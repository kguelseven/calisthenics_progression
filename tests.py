...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_workouts(self):
        ...
        now = datetime.utcnow()
        p1 = Workout(title="Workout from john", athlet=u1,
                  timestamp=now + timedelta(seconds=1))
        p2 = Workout(title="Workout from susan", athlet=u2,
                  timestamp=now + timedelta(seconds=4))
        p3 = Workout(title="Workout from mary", athlet=u3,
                  timestamp=now + timedelta(seconds=3))
        p4 = Workout(title="Workout from david", athlet=u4,
